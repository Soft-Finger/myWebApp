...
public class GameTest {
    ...
    public void testAddGoal () {
        Team t1 = new Team ( 100, "Senators d'Ottawa", "Ontario" );
        Team t2 = new Team ( 101, "Maple Leafs de Toronto", "Ontario" );
    ...
    public void testGetIDGame () {
        Team t1 = new Team ( 123, "Senators d'Ottawa", "Ontario" );
        Team t2 = new Team ( 101, "Maple Leafs de Toronto", "Ontario" );
    ...
    public void testGetIDEquipeVisiteur () {
        ...
        Team t1 = new Team ( 100, "Senators d'Ottawa", "Ontario" );
        Team t2 = new Team ( 109, "Maple Leafs de Toronto", "Ontario" );
    ...
    public void testGetListeButs () {
        ...
        League.addTeam ( t1 );
        League.addTeam ( t2 );
        Joueur auteurBut = new Joueur ( 122 , "Wise" , "Moukaila" , t1.getID () );
        Joueur assistant1 = new FieldPlayer ( 123 , "Mikhail" , "Kil" , t1.getID () );
        Joueur assistant2 = new Joueur ( 124 , "YAHAYA" , "Moukaila" , t1.getID () );
        Goalie gardienEncaisseurBut = new Goalie ( 126 , "MARDEZ" , "moukaila" , t2.getID () );
        ...
        Joueur auteurButT2 = new Joueur ( 127 , "SoftFoot" , "Saf" , t2.getID () );
        Joueur assistant1T2 = new FieldPlayer ( 128 , "KIM" , "Kil" , t2.getID () );
        Joueur assistant2T2 = new Joueur ( 129 , "MARDEZ" , "Poof" , t2.getID () );
        Goalie gardienEncaisseurButT1 = new Goalie ( 130 , "NAS" , "Ras" , t1.getID () );
