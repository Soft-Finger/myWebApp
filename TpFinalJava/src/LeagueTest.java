...
public class LeagueTest {
    ...
    public void testAddTeam() {
        ...
        Team t3 = new Team ( 102, "Hurricanes de la Caroline", "California" );
    ...
    @Test
    public void addTeamSameName() {
        Team t1 = new Team ( 100, "Senators d'Ottawa", "Ontario" );
        Team t2 = new Team ( 101, "Senators d'Ottawa", "Ontario" );
    ...
    public void testGetTeam() {
        ...
        assertEquals ( "Hurricanes de la Caroline", res );
    }
    ...
    public void testAddGame() {
        ...
        Team t2 = new Team ( 101, "Maple Leafs de Toronto", "Ontario" );
        Team t3 = new Team ( 102, "Hurricanes de la Caroline", "California" );
        Team t4 = new Team ( 102, "Blue Jackets de Columbus", "Columbus" );
